...
defined(WEBOS_INSTALL_WEBOS_APPLICATIONSDIR, var) {
    base.path = $$WEBOS_INSTALL_WEBOS_APPLICATIONSDIR/com.webos.exampleapp.qmllocalization
    base.files = $$files(webos-metadata/*) $$files(*.qml)
    INSTALLS += base

    CONFIG += lrelease
    EXTRA_TRANSLATIONS = qml-webos-framework_en.ts
    QM_FILES_INSTALL_PATH = $$WEBOS_INSTALL_DATADIR/qml/locales/qml-webos-framework
    # QTBUG-77398
